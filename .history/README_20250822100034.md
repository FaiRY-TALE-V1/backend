...
FaiRY TALE은 OpenAI의 최신 AI 기술을 활용하여 아이 개인의 특성에 맞춘 교육 동화를 자동 생성하는 혁신적인 서비스입니다. 아이의 이름, 나이, 성별, 사진을 입력하면 AI가 6개 장면으로 구성된 완전한 동화책(삽화 + 스토리 + 음성)을 3-5분 내에 제작합니다.
...
- **React 19** + **TypeScript**: 타입 안전한 UI 개발
...
- **UI**: 5가지 테마 카드 형태 표시
- **기능**: 호버 효과, 선택 상태 시각화
- **테마**: 💝감정표현, 🤝교우관계, 🥕식습관, 🛡️안전습관, 💰경제관념

#### 4️⃣ 동화 생성 및 재생 (`/story`)

- **생성 단계**: 실시간 로딩 메시지 (2초마다 업데이트)
- **재생 기능**:
  - 6개 장면 슬라이드 뷰어
  - TTS 오디오 재생/일시정지 컨트롤
  - 키보드 네비게이션 (←→ 화살표 키)
